...
const aggiornaTestoToggle = (toggle) => {
    if (!toggle) return;
...
const impostaTema = (theme, toggle) => {
    document.body.dataset.theme = theme;
    aggiornaTestoToggle(toggle);
};

const inizializzaTema = () => {
